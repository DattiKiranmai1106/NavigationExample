		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapktnavnavigationexample-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapktnavnavigationexample-display": {
								"semanticObject": "comsapktnavnavigationexample",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.kt.nav.navigationexample",
									"url": sap.ui.require.toUrl("com/sap/kt/nav/navigationexample")
								}
							}
						}
					}
